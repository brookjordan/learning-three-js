...
const shaderMods = {
  _w: 0.05,
  set w(multiplier: number) { this.update('_w', multiplier); },
  get w() { return this._w; },

  _h: 0.05,
  set h(multiplier: number) { this.update('_h', multiplier); },
  get h() { return this._h; },

  _a: 0.1,
  set a(multiplier: number) { this.update('_a', multiplier); },
  get a() { return this._a; },

  _b: 0.1,
  set b(multiplier: number) { this.update('_b', multiplier); },
  get b() { return this._b; },

  _aa: 0.1,
  set aa(multiplier: number) { this.update('_aa', multiplier); },
  get aa() { return this._aa; },

  _bb: 0.1,
  set bb(multiplier: number) { this.update('_bb', multiplier); },
  get bb() { return this._bb; },

  _c: 0.5,
  set c(multiplier: number) { this.update('_c', multiplier); },
  get c() { return this._c; },

  _cc: 0.2,
  set cc(multiplier: number) { this.update('_cc', multiplier); },
  get cc() { return this._cc; },

  _x: 1,
  set x(multiplier: number) { this.update('_x', multiplier); },
  get x() { return this._x; },

  _y: 1,
  set y(multiplier: number) { this.update('_y', multiplier); },
  get y() { return this._y; },

  _z: 1,
  set z(multiplier: number) { this.update('_z', multiplier); },
